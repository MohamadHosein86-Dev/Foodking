...
export default function AddToShoppingCard({
  ...
  return (
    <div
      className="flex mt-18 flex-wrap justify-center h-full 
    w-2/3
    ...
    >
     ...
     w-full
      ...
      md:w-full
     w-full 
      flex flex-wrap h-1/2 justify-end content-center"
        >
         ...
         bg-green-700 w-60 h-16 mt-12 mr-2 group rounded-lg"
          ...
          w-32 mt-12 flex justify-center items-center"
          >
            <button
      ...
      <div className=" w-full  h-[700px] mt-12">
        ...
        {description === 1 ? (
         ...
         mt-2
              ...
              md:h-28
              h-18
                text-right mb-8 py-2 w-full border-1 border-slate-200 
                 px-6 "
