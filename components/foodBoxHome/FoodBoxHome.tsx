...
export default function FoodBoxHome({ bg, box, color = "text-[#fff]", price = "", colorPrice = "text-[#212121]" }: propsType) {
  return (
    <div dir="rtl" className=" w-full md:w-[30rem]  relative  p-12 text-white h-[25rem] bg_home ">
      <div>
        ...
        <button
          className={` mt-[1.5rem] ${bg} ${color} relative overflow-hidden outline-none  cursor-pointer  bg-[#D12525] text-white font-bold 
 w-[15rem]  md:w-[17rem] py-[1rem] pb-[1.3rem] px-[1rem] flex  items-center justify-center gap-[.5rem] group h-16 `}
        >
