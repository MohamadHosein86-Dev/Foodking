...
export default function FoodProcessingAboutUs() {
  return (
    <div className="min-h-screen mt-4 flex flex-col items-center py-12">
      ...
      <div className="flex flex-col md:flex-row-reverse justify-center items-center gap-8 max-w-5xl mx-auto p-6">
        <div className="flex-1 container transition duration-300 ease-in delay-150 hover:border hover:border-dotted hover:bg-white justify-center rounded-lg h-[480px] flex flex-col items-center text-center p-4">
          <div className="relative w-60 sm:w-80  h-80 mb-4">
            <Image src={"/home/01.png"} alt="Delivery" layout="fill" objectFit="contain" className="rounded-lg  " />
            <h2 className=" number hidden absolute top-6 right-28 transition ease-in delay-100 bg-green-700 px-2 py-1 rounded-full text-lg font-semibold text-white">01</h2>
          </div>
        ...
        <div className="flex-1 container border border-dotted bg-white justify-center rounded-lg h-[480px] flex flex-col items-center text-center p-4">
          <div className="relative w-60 sm:w-80 h-80 mb-4">
            <Image src={"/home/02.png"} alt="Delivery" layout="fill" objectFit="contain" className="rounded-lg" />
        ...
        <div className="flex-1 container transition duration-300 ease-in-out delay-150 hover:border hover:border-dotted hover:bg-white justify-center rounded-lg h-[480px] flex flex-col items-center text-center p-4">
          <div className="relative w-60 sm:w-80 h-80 mb-4">
            <Image src={"/home/03-1.png"} alt="Delivery" layout="fill" objectFit="contain" className="rounded-lg" />
