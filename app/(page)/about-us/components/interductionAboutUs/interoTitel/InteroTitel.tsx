...
export default function InteroTitle() {
  return (
    <div className="  basis-[50%] relative mb-10 md:mb-0">
      <div className=" relative  ">
        ...
        <Image className=" absolute top-[1rem] " width={800} height={600} alt="Burger" src="https://modinatheme.com/foodking/wp-content/uploads/2024/02/burger-text-4.png" />
      </div>
