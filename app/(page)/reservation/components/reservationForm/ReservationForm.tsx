import DateInputReservation from "../dateInputReservation/DateInputReservation";

export default function ReservationForm() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <form className="text-white bg-[url(https://modinatheme.com/foodking/wp-content/uploads/2024/03/bg-shape.png)] bg-cover bg-no-repeat bg-green-800 object-contain rounded-2xl p-6 md:p-10 w-full max-w-4xl shadow-lg">
