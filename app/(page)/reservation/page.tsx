        ...
        <div className="text-white bg-[url(https://modinatheme.com/foodking/wp-content/uploads/2024/03/bg-shape.png)] bg-cover bg-no-repeat bg-green-800 object-contain rounded-2xl p-6 md:p-10 w-full max-w-4xl shadow-lg">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6 text-right">
            ...
            <div className="flex flex-col gap-2">
              <select
                id="countries"
                className="border cursor-pointer border-gray-100 text-white rounded-lg focus:outline-none placeholder:text-white block w-full p-4"
              >
            ...
            <div className="flex flex-col gap-2 !justify-center">
              <div className="relative">
                ...
                <input
                  type="text"
                  id="input-group-1"
                  className="p-4 border border-gray-300 text-white rounded-lg focus:outline-none placeholder:text-white block w-full"
            ...
            <div className="flex flex-col gap-2">
              <div className="relative">
                ...
                <input
                  type="text"
                  id="input-group-1"
                  className="p-4 focus:outline-none placeholder:text-white !border !border-gray-100 text-white rounded-lg block w-full"
