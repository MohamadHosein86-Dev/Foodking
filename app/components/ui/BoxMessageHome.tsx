...
export default function BoxMessageHome() {
  return (
    <section className=" max-w-[80rem] mb-[5rem]  flex px-4 md:px-12 mx-auto">
      <div className=" relative bg-masseghome    py-30  px-6 md:px-18 gap-[1.5rem] xl:gap-[6rem] xl:flex-row flex-col flex  mx-auto ">
        ...
        <form className="z-[1000] w-full  relative xl:w-[42%] ">
          ...
          <button
            className=" mt-[1rem]   bg-[#d12525] text-[#fff] relative overflow-hidden outline-none  cursor-pointer  font-bold 
  w-[14rem] py-[1rem] pb-[1.3rem] px-[1rem] flex items-center justify-center gap-[.5rem] group h-15 "
          >
