...
export default function CommentsSec() {
  return (
    <ScrollAnimation direction="up" delay={0.3}>
      <div className=" text-[#ffff]  py-32  bg-sectionhome  bg-[#1A1919] ">
        <div className="  max-w-7xl gap-12 grid grid-cols-1 sm:grid-cols-2  md:grid-cols-3 xl:grid-cols-4 p-4 mx-auto">
