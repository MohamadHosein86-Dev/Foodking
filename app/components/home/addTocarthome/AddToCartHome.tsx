    ...
    return (
      <div className="absolute bottom-4 left-1/2 top-28 h-0 -translate-x-1/2 w-[85%] flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
        <div className="absolute bottom-4 left-1/2 top-36 -translate-x-1/2 w-[85%] flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
          <button onClick={() => AddToCartProdcuts()} className="relative cursor-pointer w-full mt-12 group rounded-full h-10 overflow-hidden">
      ...
      <div className="absolute bottom-4 left-1/2 top-28 h-0 -translate-x-1/2 w-[85%] flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
        <div className="absolute bottom-4 left-1/2 top-36 -translate-x-1/2 w-[85%] flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 z-10">
          <button onClick={() => AddToCartProdcuts()} className="relative cursor-pointer w-full mt-12 group rounded-full h-10 overflow-hidden">
            ...
            <div className="relative z-10 flex justify-center items-center h-full w-full">
              <p className="text-black group-hover:text-white px-4 py-2.5 text-sm font-semibold transition-colors duration-500"> موجود در سبد خرید ({count?.count}) </p>
            </div>
          </button>
        </div>
      </div>
