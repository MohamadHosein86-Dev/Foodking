            ...
            <div className={` z-50  ${Pathname == "/" ? "border-b border-b-neutral-200 " : " border-none "} `}>
              <div className={`  text-[#fcfbfe] mx-auto max-w-7xl py-1.5 items-center flex justify-between  sm:px-6 `}>
                <div className=" flex items-center gap-20 md:gap-6 ">
                  ...
                  <button className="relative overflow-hidden outline-none rounded-md cursor-pointer  bg-[#D12525] text-white font-bold   w-60 py-4 pb-5 px-4 xl:flex hidden items-center justify-center gap-2 group h-16">
                ...
                <div className=" hidden xl:flex text-[#212121] gap-8 relative ">
                      ...
                      {showBox && (
                        <motion.div className="absolute shadow-md  -right-0 top-10 border-1 border-[#eeeeee] bg-[#ffffff] rounded-md w-56 overflow-hidden" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }}>
                          <ul className="flex shadow-md  rounded-md flex-col text-right text-[#212121]">
                            ...
                            <Link onClick={() => setShowBox(false)} className="  text-[#515151] hover:text-[#ffff] transition ease-in delay-150 hover:bg-[#D12525] py-4     " href={"/faqs"}>
                  ...
                  >
                    ...
                    <AnimatePresence>
                      {showBox3 && (
                        <motion.div className="absolute -right-0 top-10 border-1 border-[#eeeeee] bg-[#ffffff] rounded-md w-56 overflow-hidden" initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }}>
                          <ul className="flex flex-col text-right text-[#212121]   ">
